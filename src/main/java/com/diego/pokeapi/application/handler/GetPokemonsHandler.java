...
public class GetPokemonsHandler {
    ...
    public ResponseListDtos getPokemons(int offSet, int limit){
        ...
        String prev=offSet-limit<0?"":"https://modyo-test-diego.herokuapp.com/pokemon?offSet="+(offSet-limit)+"&limit="+limit;
        String next="https://modyo-test-diego.herokuapp.com/pokemon?offSet="+(offSet+limit)+"&limit="+limit;
